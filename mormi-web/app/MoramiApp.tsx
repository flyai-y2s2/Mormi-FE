          ...
          {!selectedArea ? (
            <>
              ...
              <section className="cafe-required-lessons amusement-required-lessons">
                <div><strong><span aria-hidden="true">✦</span> 곱셈·나눗셈 준비 개념</strong><span>{amusementParkConceptSessions.filter((session) => completedSessionIds.includes(session.id)).length}/{amusementParkConceptSessions.length} 완료</span></div>
