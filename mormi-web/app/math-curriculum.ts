...
const addedSessions: Session[] = [
  ...
  lesson({
    ...
    drills: [
      p("1인 3,000원인 표를 4명 모두 사면 얼마일까?", ["12,000원", "7,000원", "9,000원"], "12,000원", moneyPractice("놀이동산 입장권 네 장", "매표소", [{ label: "표 한 장", value: "3,000원" }, { label: "필요한 표", value: "4장" }], "3,000원 × 4장", [{ image: "/life-missions/money-practice/ticket-party.png", label: "입장권", count: 4 }])),
  ...
  lesson({
    ...
    drills: [
      p("표 2장, 츄러스 3개, 말랑이 1개를 사면 모두 얼마일까?", ["10,000원", "8,000원", "12,000원"], "10,000원", moneyPractice("입장권과 츄러스와 말랑이", "오늘 살 것", [{ label: "표", value: "2,000원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원" }], "각 값을 계산한 뒤 모두 더해요", [{ image: "/amusement-park/ticket-elements-v2.png", label: "입장권", count: 2 }, { image: "/amusement-park/churros-elements-v2.png", label: "츄러스", count: 3 }, { image: "/life-missions/money-practice/squishy-share.png", label: "말랑이", count: 1 }])),
      p("주스 2잔, 쿠키 3개, 열쇠고리 1개를 사면 모두 얼마일까?", ["11,000원", "9,000원", "13,000원"], "11,000원", moneyPractice("주스와 쿠키와 열쇠고리", "친구 선물", [{ label: "주스", value: "2,000원 × 2잔" }, { label: "쿠키", value: "1,000원 × 3개" }, { label: "열쇠고리", value: "4,000원" }], "각 값을 계산한 뒤 모두 더해요", [{ image: "/figma/cafe/strawberry-juice.png", label: "주스", count: 2 }, { image: "/figma/cafe/cookie.png", label: "쿠키", count: 3 }, { image: "/life-missions/money-practice/keychain-budget.png", label: "열쇠고리", count: 1 }])),
      p("예산 15,000원으로 표 2장, 케이크 1개, 장난감 1개를 산 뒤 남는 돈은?", ["2,000원", "3,000원", "1,000원"], "2,000원", moneyPractice("입장권과 케이크와 장난감", "예산 확인", [{ label: "표", value: "3,000원 × 2장" }, { label: "케이크", value: "4,500원" }, { label: "장난감", value: "2,500원" }, { label: "예산", value: "15,000원" }], "쓴 돈을 모두 더한 뒤 예산에서 빼요", [{ image: "/life-missions/money-practice/ticket-party.png", label: "입장권", count: 2 }, { image: "/figma/cafe/strawberry-cake.png", label: "케이크", count: 1 }, { image: "/life-missions/products/toy.jpg", label: "장난감", count: 1 }])),
  ...
  lesson({
    ...
    drills: [
      p("예산 10,000원으로 2,000원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["5개", "4개", "6개"], "5개", moneyPractice("별 열쇠고리와 동전 지갑", "기념품 가게", [{ label: "한 개 가격", value: "2,000원" }, { label: "예산", value: "10,000원" }], "10,000원 ÷ 2,000원", [{ image: "/life-missions/money-practice/keychain-budget.png", label: "별 열쇠고리", count: 1 }])),
