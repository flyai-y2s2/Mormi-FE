...
const addedSessions: Session[] = [
  ...
  lesson({
    ...
    drills: [
      p("1인 3,000원인 표를 4명 모두 사면 얼마일까?", ["12,000원", "7,000원", "9,000원"], "12,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "3,000원" }, { label: "우리 일행", value: "4명" }], equation: "3,000원 × 4명" }),
      p("1인 2,500원인 표를 4명 모두 사면 얼마일까?", ["10,000원", "6,500원", "8,000원"], "10,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "2,500원" }, { label: "우리 일행", value: "4명" }], equation: "2,500원 × 4명" }),
      p("1인 3,500원인 표를 4명 모두 사면 얼마일까?", ["14,000원", "7,500원", "12,000원"], "14,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "3,500원" }, { label: "우리 일행", value: "4명" }], equation: "3,500원 × 4명" }),
      p("1인 4,000원인 표를 4명 모두 사면 얼마일까?", ["16,000원", "8,000원", "12,000원"], "16,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "4,000원" }, { label: "우리 일행", value: "4명" }], equation: "4,000원 × 4명" }),
      p("1인 2,000원인 표를 4명 모두 사면 얼마일까?", ["8,000원", "6,000원", "10,000원"], "8,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "2,000원" }, { label: "우리 일행", value: "4명" }], equation: "2,000원 × 4명" }),
      p("1인 1,500원인 표를 4명 모두 사면 얼마일까?", ["6,000원", "5,500원", "4,000원"], "6,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권 네 장", badge: "매표소", facts: [{ label: "1인 입장료", value: "1,500원" }, { label: "우리 일행", value: "4명" }], equation: "1,500원 × 4명" }),
    ],
    transfer: [p("2,000원짜리 놀이기구 표 3장은 얼마일까?", ["6,000원", "5,000원", "8,000원"], "6,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권", facts: [{ label: "표 한 장", value: "2,000원" }, { label: "필요한 표", value: "3장" }], equation: "2,000원 × 3장" }), p("1,500원짜리 표 2장은 얼마일까?", ["3,000원", "2,000원", "3,500원"], "3,000원", { type: "money-practice", image: "/life-missions/money-practice/ticket-party.png", imageAlt: "놀이동산 입장권", facts: [{ label: "표 한 장", value: "1,500원" }, { label: "필요한 표", value: "2장" }], equation: "1,500원 × 2장" })],
  }),
  lesson({
    ...
    drills: [
      p("2,500원짜리 간식 세트 2개의 값을 덧셈으로 나타내면?", ["2,500원 + 2,500원", "2,500원 + 2원", "5,000원 + 2원"], "2,500원 + 2,500원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "2,500원" }, { label: "세트 수", value: "2개" }], equation: "같은 가격을 2번 더해요" }),
      p("3,000원짜리 간식 세트 2개는 모두 얼마일까?", ["6,000원", "5,000원", "3,002원"], "6,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "3,000원" }, { label: "세트 수", value: "2개" }], equation: "3,000원 + 3,000원" }),
      p("1,500원짜리 간식 세트 2개의 값을 덧셈으로 나타내면?", ["1,500원 + 1,500원", "1,500원 + 2원", "3,000원 + 2원"], "1,500원 + 1,500원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "1,500원" }, { label: "세트 수", value: "2개" }], equation: "같은 가격을 2번 더해요" }),
      p("4,000원짜리 간식 세트 2개는 모두 얼마일까?", ["8,000원", "6,000원", "4,002원"], "8,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "4,000원" }, { label: "세트 수", value: "2개" }], equation: "4,000원 + 4,000원" }),
      p("2,000원짜리 간식 세트 2개의 값을 덧셈으로 나타내면?", ["2,000원 + 2,000원", "2,000원 + 2원", "4,000원 + 2원"], "2,000원 + 2,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "2,000원" }, { label: "세트 수", value: "2개" }], equation: "같은 가격을 2번 더해요" }),
      p("3,500원짜리 간식 세트 2개는 모두 얼마일까?", ["7,000원", "5,500원", "3,502원"], "7,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "똑같은 놀이동산 간식 세트 두 개", badge: "간식가게", facts: [{ label: "한 세트", value: "3,500원" }, { label: "세트 수", value: "2개" }], equation: "3,500원 + 3,500원" }),
    ],
    transfer: [p("1,000원짜리 음료 3개의 값을 덧셈으로 나타내면?", ["1,000원 + 1,000원 + 1,000원", "1,000원 + 3원", "3,000원 + 3원"], "1,000원 + 1,000원 + 1,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "놀이동산 간식", facts: [{ label: "음료 한 개", value: "1,000원" }, { label: "음료 수", value: "3개" }], equation: "같은 가격을 3번 더해요" }), p("2,000원짜리 간식 3개는 모두 얼마일까?", ["6,000원", "5,000원", "2,003원"], "6,000원", { type: "money-practice", image: "/life-missions/money-practice/snack-repeat.png", imageAlt: "놀이동산 간식", facts: [{ label: "간식 한 개", value: "2,000원" }, { label: "간식 수", value: "3개" }], equation: "2,000원 + 2,000원 + 2,000원" })],
  }),
  lesson({
    ...
    drills: [
      p("표 2장, 츄러스 3개, 말랑이 1개를 사면 모두 얼마일까?", ["10,000원", "8,000원", "12,000원"], "10,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "오늘 살 것", facts: [{ label: "표", value: "2,000원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원 × 1개" }], equation: "각 값을 계산한 뒤 모두 더해요" }),
      p("표 2장, 츄러스 3개, 말랑이 1개를 사면 모두 얼마일까?", ["11,000원", "9,000원", "13,000원"], "11,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "오늘 살 것", facts: [{ label: "표", value: "2,500원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원 × 1개" }], equation: "각 값을 계산한 뒤 모두 더해요" }),
      p("예산 15,000원으로 표와 간식, 말랑이를 산 뒤 남는 돈은?", ["2,000원", "3,000원", "1,000원"], "2,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "예산 확인", facts: [{ label: "표", value: "3,000원 × 2장" }, { label: "츄러스", value: "1,500원 × 3개" }, { label: "말랑이", value: "2,500원" }, { label: "예산", value: "15,000원" }], equation: "쓴 돈을 모두 더한 뒤 예산에서 빼요" }),
      p("예산 12,000원으로 표와 간식, 말랑이를 모두 살 수 있을까?", ["살 수 있어요", "1,000원 모자라요", "2,000원 모자라요"], "살 수 있어요", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "예산 확인", facts: [{ label: "표", value: "2,000원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원" }, { label: "예산", value: "12,000원" }], equation: "전체 값과 예산을 비교해요" }),
      p("예산 10,000원으로 표와 간식, 말랑이를 사려면 얼마가 모자랄까?", ["1,000원", "2,000원", "3,000원"], "1,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "예산 확인", facts: [{ label: "표", value: "2,500원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원" }, { label: "예산", value: "10,000원" }], equation: "전체 값과 예산의 차이를 찾아요" }),
      p("표 2장, 츄러스 3개, 말랑이 1개를 사면 모두 얼마일까?", ["9,000원", "8,000원", "10,000원"], "9,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "입장권 두 장과 츄러스 세 개와 말랑이 장난감", badge: "오늘 살 것", facts: [{ label: "표", value: "1,500원 × 2장" }, { label: "츄러스", value: "1,000원 × 3개" }, { label: "말랑이", value: "3,000원 × 1개" }], equation: "각 값을 계산한 뒤 모두 더해요" }),
    ],
    transfer: [p("표 2장과 간식 2개를 사면 모두 얼마일까?", ["8,000원", "7,000원", "9,000원"], "8,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "놀이동산에서 살 물건들", facts: [{ label: "표", value: "3,000원 × 2장" }, { label: "간식", value: "1,000원 × 2개" }], equation: "각 값을 계산한 뒤 더해요" }), p("예산 10,000원에서 8,000원을 쓰면 얼마가 남을까?", ["2,000원", "1,000원", "3,000원"], "2,000원", { type: "money-practice", image: "/life-missions/money-practice/mixed-purchase.png", imageAlt: "놀이동산에서 살 물건들", facts: [{ label: "예산", value: "10,000원" }, { label: "쓴 돈", value: "8,000원" }], equation: "예산 - 쓴 돈" })],
  }),
  lesson({
  ...
  lesson({
    ...
    drills: [
      p("말랑이 묶음 9,000원을 3명이 똑같이 내면 한 명당 얼마일까?", ["3,000원", "6,000원", "4,500원"], "3,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "9,000원" }, { label: "함께 낼 사람", value: "3명" }], equation: "9,000원 ÷ 3명" }),
      p("말랑이 묶음 12,000원을 3명이 똑같이 내면 한 명당 얼마일까?", ["4,000원", "6,000원", "3,000원"], "4,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "12,000원" }, { label: "함께 낼 사람", value: "3명" }], equation: "12,000원 ÷ 3명" }),
      p("말랑이 묶음 15,000원을 3명이 똑같이 내면 한 명당 얼마일까?", ["5,000원", "3,000원", "7,500원"], "5,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "15,000원" }, { label: "함께 낼 사람", value: "3명" }], equation: "15,000원 ÷ 3명" }),
      p("말랑이 묶음 6,000원을 3명이 똑같이 내면 한 명당 얼마일까?", ["2,000원", "3,000원", "1,000원"], "2,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "6,000원" }, { label: "함께 낼 사람", value: "3명" }], equation: "6,000원 ÷ 3명" }),
      p("말랑이 묶음 10,500원을 3명이 똑같이 내면 한 명당 얼마일까?", ["3,500원", "5,250원", "2,500원"], "3,500원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "10,500원" }, { label: "함께 낼 사람", value: "3명" }], equation: "10,500원 ÷ 3명" }),
      p("말랑이 묶음 7,500원을 3명이 똑같이 내면 한 명당 얼마일까?", ["2,500원", "3,500원", "1,500원"], "2,500원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "말랑이 장난감 여섯 개와 나눔 접시 세 개", badge: "같이 사기", facts: [{ label: "전체 값", value: "7,500원" }, { label: "함께 낼 사람", value: "3명" }], equation: "7,500원 ÷ 3명" }),
    ],
    transfer: [p("간식값 8,000원을 4명이 똑같이 내면 한 명당?", ["2,000원", "4,000원", "1,000원"], "2,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "함께 나눌 놀이동산 간식", facts: [{ label: "전체 값", value: "8,000원" }, { label: "함께 낼 사람", value: "4명" }], equation: "8,000원 ÷ 4명" }), p("간식값 10,000원을 2명이 똑같이 내면 한 명당?", ["5,000원", "2,000원", "8,000원"], "5,000원", { type: "money-practice", image: "/life-missions/money-practice/squishy-share.png", imageAlt: "함께 나눌 놀이동산 간식", facts: [{ label: "전체 값", value: "10,000원" }, { label: "함께 낼 사람", value: "2명" }], equation: "10,000원 ÷ 2명" })],
  }),
  lesson({
    ...
    drills: [
      p("예산 10,000원으로 2,000원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["5개", "4개", "6개"], "5개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "2,000원" }, { label: "예산", value: "10,000원" }], equation: "10,000원 ÷ 2,000원" }),
      p("예산 12,000원으로 3,000원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["4개", "3개", "5개"], "4개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "3,000원" }, { label: "예산", value: "12,000원" }], equation: "12,000원 ÷ 3,000원" }),
      p("예산 15,000원으로 2,500원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["6개", "5개", "7개"], "6개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "2,500원" }, { label: "예산", value: "15,000원" }], equation: "15,000원 ÷ 2,500원" }),
      p("예산 9,000원으로 1,500원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["6개", "5개", "7개"], "6개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "1,500원" }, { label: "예산", value: "9,000원" }], equation: "9,000원 ÷ 1,500원" }),
      p("예산 14,000원으로 2,000원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["7개", "6개", "8개"], "7개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "2,000원" }, { label: "예산", value: "14,000원" }], equation: "14,000원 ÷ 2,000원" }),
      p("예산 12,500원으로 2,500원짜리 별 열쇠고리를 몇 개 살 수 있을까?", ["5개", "4개", "6개"], "5개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "별 모양 열쇠고리와 동전 지갑", badge: "기념품 가게", facts: [{ label: "한 개 가격", value: "2,500원" }, { label: "예산", value: "12,500원" }], equation: "12,500원 ÷ 2,500원" }),
    ],
    transfer: [p("8,000원으로 2,000원짜리 기념품을 몇 개 살 수 있을까?", ["4개", "3개", "5개"], "4개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "놀이동산 기념품", facts: [{ label: "한 개 가격", value: "2,000원" }, { label: "예산", value: "8,000원" }], equation: "8,000원 ÷ 2,000원" }), p("15,000원으로 5,000원짜리 기념품을 몇 개 살 수 있을까?", ["3개", "2개", "4개"], "3개", { type: "money-practice", image: "/life-missions/money-practice/keychain-budget.png", imageAlt: "놀이동산 기념품", facts: [{ label: "한 개 가격", value: "5,000원" }, { label: "예산", value: "15,000원" }], equation: "15,000원 ÷ 5,000원" })],
  }),
